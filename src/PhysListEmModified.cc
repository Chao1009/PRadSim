...
// ********************************************************************
//
// PhysListEmModified.cc
// Developer : Geant4
// Modified by Chao Gu from G4EmStandardPhysics_option4.cc
// History:
...
#include "G4DipBustGenerator.hh" // added for Brems test
#include "G4ModifiedTsai.hh" // added for Brems test
#include "G4Generator2BS.hh"
#include "G4Generator2BN.hh" // added for Brems test
#include "G4PenelopeBremsstrahlungAngular.hh" // added for Brems test
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(PhysListEmModified);
...
PhysListEmModified::PhysListEmModified(G4int ver, const G4String &) : G4VPhysicsConstructor("EmModified"), verbose(ver)
{
    ...
    fBremsAngularGeneratorType = "DipBust";
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

PhysListEmModified::~PhysListEmModified()
{
    //
}
...
void PhysListEmModified::ConstructParticle()
{
    // gamma
    G4Gamma::Gamma();
...
void PhysListEmModified::ConstructProcess()
{
    if (verbose > -1)
    ...
    while ((*myParticleIterator)()) {
        ...
        if (particleName == "gamma") {
            ...
            */
            ...
            SetBremsstrahlungAngularGenerator(br1, fBremsAngularGeneratorType);
            SetBremsstrahlungAngularGenerator(br2, fBremsAngularGeneratorType);
...
void PhysListEmModified::SetBremsstrahlungAngularGenerator(G4VEmModel *model, const G4String &type)
{
    if (type == "tsai")
        model->SetAngularDistribution(new G4ModifiedTsai());
    else if (type == "2BS")
        model->SetAngularDistribution(new G4Generator2BS());
    else if (type == "2BN")
        model->SetAngularDistribution(new G4Generator2BN());
    else if (type == "penelope")
        model->SetAngularDistribution(new G4PenelopeBremsstrahlungAngular());
    else
        model->SetAngularDistribution(new G4DipBustGenerator());
}
